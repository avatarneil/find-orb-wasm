...
let engineData=null,engineWasm=null,busy=false;
self.onmessage=async event => {
  ...
  try {
    if (type==='init') {
      ...
      const result=await FindOrbRuntime.execute(createFindOrb,FIND_ORB_MANIFEST,engineData,engineWasm,args,files,outputs);
